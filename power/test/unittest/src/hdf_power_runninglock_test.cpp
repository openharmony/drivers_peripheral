...
constexpr int32_t DEFAULT_RUNNINGLOCK_INVAILD_TYPE = 100;
...
/**
  ...
  * @tc.desc: test Hold, running lock type is invaild
  * @tc.type: FUNC
  * @tc.require: issueI6IU18
  */
HWTEST_F(HdfPowerRunningLockTest, HdfPowerRunningLockTest002, TestSize.Level1)
{
    ...
    runinglockInfo.type = static_cast<RunningLockType>(DEFAULT_RUNNINGLOCK_INVAILD_TYPE);
    runinglockInfo.timeoutMs = RUNNINGLOCK_TIMEOUT_NONE;
...
/**
  ...
  * @tc.desc: test Unhold, running lock type is invaild
  * @tc.type: FUNC
  * @tc.require: issueI6IU18
  */
