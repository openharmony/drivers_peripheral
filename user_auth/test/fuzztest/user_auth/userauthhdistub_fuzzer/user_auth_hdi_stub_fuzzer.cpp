...
#include "v4_1/user_auth_interface_stub.h"
...
bool UserAuthHdiStubFuzzTest(const uint8_t *rawData, size_t size)
{
    ...
    sptr<OHOS::HDI::UserAuth::V4_1::IUserAuthInterface> serviceImpl =
        OHOS::HDI::UserAuth::V4_1::IUserAuthInterface::Get(true);
    if (serviceImpl == nullptr) {
        IAM_LOGE("%{public}s:IUserAuthInterface::Get() failed.", __func__);
        return false;
    }
    sptr<OHOS::HDI::UserAuth::V4_1::UserAuthInterfaceStub> userAuthInterfaceStub =
        new OHOS::HDI::UserAuth::V4_1::UserAuthInterfaceStub(serviceImpl);
