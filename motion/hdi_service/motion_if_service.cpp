...
{
    HDF_LOGI("%{public}s: Enter the EnableMotion function, motionType is %{public}d" , __func__, motionType);
    if (motionVdiImpl_ == nullptr) {
...
{
    HDF_LOGI("%{public}s: Enter the DisableMotion function, motionType is %{public}d" , __func__, motionType);
    if (motionVdiImpl_ == nullptr) {
        HDF_LOGE("%{public}s motionVdiImpl_ is nullptr", __func__);
        return HDF_FAILURE;
    }
...
{
    HDF_LOGI("%{public}s: Enter the Register function.", __func__);
    if (motionVdiImpl_ == nullptr) {
        HDF_LOGE("%{public}s motionVdiImpl_ is nullptr", __func__);
        return HDF_FAILURE;
    }
...
{
    HDF_LOGI("%{public}s: Enter the Unregister function.", __func__);
    if (motionVdiImpl_ == nullptr) {
        HDF_LOGE("%{public}s motionVdiImpl_ is nullptr", __func__);
        return HDF_FAILURE;
    }
