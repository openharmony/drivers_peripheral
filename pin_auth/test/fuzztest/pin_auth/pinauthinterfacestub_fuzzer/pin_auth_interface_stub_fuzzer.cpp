...
const std::u16string PIN_AUTH_INTERFACE_TOKEN = u"ohos.hdi.pin_auth.v1_1.IPinAuthInterface";
bool PinAuthInterfaceStubFuzzTest(const uint8_t *rawData, size_t size)
{
    ...
    OHOS::HDI::PinAuth::V1_1::PinAuthInterfaceStub pinAuthInterfaceStub(pinAuthInterface);
