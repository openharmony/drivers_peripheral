...
const std::u16string EXECUTOR_STUB_TOKEN_V1_0 = u"ohos.hdi.fingerprint_auth.v1_0.IAllInOneExecutor";
const std::u16string EXECUTOR_STUB_TOKEN_V1_1 = u"ohos.hdi.fingerprint_auth.v2_0.IAllInOneExecutor";

bool FingerprintAuthHdiStubFuzzTest(const uint8_t *rawData, size_t size)
{
    IAM_LOGI("start");
    if (rawData == nullptr) {
...
{
    OHOS::HDI::FingerprintAuth::FingerprintAuthHdiStubFuzzTest(data, size);
    return 0;
}
