...
bool CommandParse::Parse(int argc, char *argv[], CommandOpt &opt)
{
    ...
    while (1) {
        int optionIndex = 0;
        static struct option long_options[] = {{"width", required_argument, 0, (int)MyOptIndex::OPT_INDEX_WIDTH},
                                               ...
                                               {"nocopy", no_argument, NULL, (int)MyOptIndex::OPT_INDEX_BUFFER_HANDLE},
                                               {"HEVC", no_argument, NULL, (int)MyOptIndex::OPT_INDEX_HEVC},
