...
public:
    ...
    int32_t CreateByStandard(int32_t standard, bool isEncoder,
         const sptr<OHOS::HDI::Codec::Zcodec::V1_0::HdiZCallback>& cb, const sptr<OHOS::HDI::Codec::ParcelableParam>& param, sptr<OHOS::HDI::Codec::Zcodec::V1_0::HdiZComponent>& instance) override;
