...
int32_t CodecComponentService::SendCommand(uint32_t cmd, uint32_t param, const std::vector<int8_t> &cmdData)
{
...
int32_t CodecComponentService::GetState(uint32_t &state)
{
