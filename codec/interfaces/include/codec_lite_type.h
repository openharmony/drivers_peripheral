 ...
 * @{
 *
 * @brief Defines codec-related APIs for MEDIA_INTERFACE_V1_0 (lite).
 *
 * @since 1.0
 * @version 1.0
 */
...
/**
 * @file codec_lite_type.h
 *
 * @brief Declares custom data types used when MEDIA_INTERFACE_V1_0 is enabled,
...
#ifndef CODEC_LITE_TYPE_H
#define CODEC_LITE_TYPE_H

#include <stdint.h>
#include <stdbool.h>
#include "codec_common_lite_type.h"
...
typedef enum {
    ...
    MEDIA_MIMETYPE_AUDIO_LPCM,      /**< LPCM audio */
