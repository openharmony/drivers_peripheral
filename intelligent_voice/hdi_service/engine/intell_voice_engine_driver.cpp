...
#include "v1_3/intell_voice_engine_manager_stub.h"
...
static int HdfIntellVoiceEngineManagerDriverBind(struct HdfDeviceObject *deviceObject)
{
    ...
    auto serviceImpl = OHOS::HDI::IntelligentVoice::Engine::V1_3::IIntellVoiceEngineManager::Get(true);
    ...
    hdfIntellVoiceEngineManagerHost->stub = OHOS::HDI::ObjectCollector::GetInstance().GetOrNewObject(serviceImpl,
        OHOS::HDI::IntelligentVoice::Engine::V1_3::IIntellVoiceEngineManager::GetDescriptor());
