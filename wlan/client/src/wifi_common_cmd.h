...
typedef enum {
    ...
    WIFI_WPA_CMD_PROBE_REQ_REPORT = HDF_WIFI_CMD(BASE_SERVICE_ID, CMD_P2P_PROBE_REQ_REPORT),
    WIFI_WPA_CMD_REMAIN_ON_CHANNEL = HDF_WIFI_CMD(BASE_SERVICE_ID, CMD_P2P_REMAIN_ON_CHANNEL),
    WIFI_WPA_CMD_CANCEL_REMAIN_ON_CHANNEL = HDF_WIFI_CMD(BASE_SERVICE_ID, CMD_P2P_CANCEL_REMAIN_ON_CHANNEL),
    WIFI_WPA_CMD_ADD_IF = HDF_WIFI_CMD(BASE_SERVICE_ID, CMD_P2P_ADD_IF),
    WIFI_WPA_CMD_REMOVE_IF = HDF_WIFI_CMD(BASE_SERVICE_ID, CMD_P2P_REMOVE_IF),
    WIFI_WPA_CMD_SET_AP_WPS_P2P_IE = HDF_WIFI_CMD(BASE_SERVICE_ID, CMD_P2P_SET_AP_WPS_P2P_IE),
    WIFI_WPA_CMD_GET_DRIVER_FLAGS = HDF_WIFI_CMD(BASE_SERVICE_ID, CMD_P2P_GET_DRIVER_FLAGS),
    WIFI_WPA_CMD_BUTT
} WifiWPACmdType;
