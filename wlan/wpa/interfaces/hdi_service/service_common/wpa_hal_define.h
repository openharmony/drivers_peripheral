...
#ifndef WPA_HAL_DEFINE_H
#define WPA_HAL_DEFINE_H
...
typedef enum DeviceConfigType {
    ...
    DEVICE_CONFIG_WAPI_CA_CERT = 25,
    DEVICE_CONFIG_WAPI_USER_CERT = 26,
    DEVICE_CONFIG_WAPI_PSK_KEY_TYPE = 27,
    DEVICE_CONFIG_WAPI_PSK = 28,
    /**
