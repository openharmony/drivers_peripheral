...
#ifndef WPA_P2P_HAL_H
#define WPA_P2P_HAL_H
...
struct StWifiWpaP2pInterface {
    ...
    P2pSupplicantErrCode (*wpaP2pCliCmdServiceAdd)(WifiWpaP2pInterface *p, const struct HdiP2pServiceInfo *argv);
    P2pSupplicantErrCode (*wpaP2pCliCmdServiceDel)(WifiWpaP2pInterface *p, const struct HdiP2pServiceInfo *argv);
    ...
    P2pSupplicantErrCode (*wpaP2pCliCmdRespServerDiscovery)(WifiWpaP2pInterface *p,
