...
#include "v3_0/face_auth_interface_stub.h"
...
using FaceAuthInterfaceStub = OHOS::HDI::FaceAuth::V3_0::FaceAuthInterfaceStub;
using AllInOneExecutorStub = OHOS::HDI::FaceAuth::V3_0::AllInOneExecutorStub;
