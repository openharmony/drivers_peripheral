...
static struct Bmi160DrvData *PedometerBmi160GetDrvData(void)
{
...
static int32_t ReadBmi160PedometerRawData(struct SensorCfgData *data, struct PedometerData *rawData,
    uint64_t *timestamp)
{
