...
#include <osal_mem.h>
#include "sensor_if.h"
#include "v3_1/sensor_interface_stub.h"
...
static int32_t HdfSensorInterfaceDriverBind(struct HdfDeviceObject *deviceObject)
{
    ...
    auto serviceImpl = OHOS::HDI::Sensor::V3_1::ISensorInterface::Get(true);
    ...
    hdfSensorInterfaceHost->stub = OHOS::HDI::ObjectCollector::GetInstance().GetOrNewObject(serviceImpl,
        OHOS::HDI::Sensor::V3_1::ISensorInterface::GetDescriptor());
