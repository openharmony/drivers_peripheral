...
public:
    ...
    void EraseSensorBestConfig(SensorHandle sensorHandle);
    ...
    std::unordered_map<SensorHandle, std::set<int32_t>> GetSensorBatchUsed();
    ...
    void AddServiceToBatchUsed(SensorHandle sensorHandle, int serviceId);
    void RemoveServiceFromBatchUsed(SensorHandle sensorHandle, int serviceId);
    std::set<int32_t> GetBatchUsedServices(SensorHandle sensorHandle);
    ...
    std::mutex sensorBatchUsedMutex_;
...
private:
    ...
    std::unordered_map<SensorHandle, std::set<int32_t>> sensorBatchUsed_;
