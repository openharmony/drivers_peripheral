...
namespace {
    ...
    constexpr int64_t CLIENT1_SAMPLING_INTERVAL = 1000000000;
    constexpr int32_t TOTAL_SECONDS = 14;
    constexpr int32_t EXPECTED_MIN_COUNT_PER_SECOND = 1;

    class SensorFourClientsClient1Test : public testing::Test {
    public:
    ...
    void SensorFourClientsClient1Test::SetUpTestCase()
    {
    ...
    void SensorFourClientsClient1Test::TearDownTestCase()
    {
    }

    void SensorFourClientsClient1Test::SetUp()
    {
    }

    void SensorFourClientsClient1Test::TearDown()
    {
    }

    /**
     * @tc.name: SensorFourClientsClient1Test1
     * @tc.desc: Client1 subscribes sensor at 1s via SetBatch, counts data for 14 seconds.
     * @tc.type: FUNC
     * @tc.require: #I4L3LF
     */
    HWTEST_F(SensorFourClientsClient1Test, SensorFourClientsClient1Test1, TestSize.Level1)
    {
