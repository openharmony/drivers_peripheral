...
#ifndef OHOS_HDI_SENSOR_V3_0_SENSORCALLBACKIMPL2_H
#define OHOS_HDI_SENSOR_V3_0_SENSORCALLBACKIMPL2_H
...
namespace Sensor {
namespace V3_0 {
class SensorCallbackImpl2 : public ISensorCallback {
public:
    virtual ~SensorCallbackImpl2() {}
    ...
    void PrintData(const HdfSensorEvents &event)
    {
        ...
        if (printDataFlag) {
            printf("%s: %s\n", __func__, st.c_str());
            HDF_LOGI("%{public}s: testcase2 %{public}s\n", __func__, st.c_str());
        }
    }
...
#endif // OHOS_HDI_SENSOR_V1_1_SENSORCALLBACKIMPL2_H
