...
#define FUZZ_PROJECT_NAME "sensorconvertsensordata_fuzzer"
...
namespace Sensor {
namespace V3_0 {
class SensorConvertSensorDataFuzzer : public ISensorCallback {
public:
    virtual ~SensorConvertSensorDataFuzzer() {}
