...
#ifndef OHOS_HDI_SECURE_ELEMENT_SIM_SECURE_ELEMENT_V1_0_SECUREELEMENTINTERFACESERVICE_H
#define OHOS_HDI_SECURE_ELEMENT_SIM_SECURE_ELEMENT_V1_0_SECUREELEMENTINTERFACESERVICE_H
...
namespace V1_0 {
class SecureElementInterfaceService :
    public OHOS::HDI::SecureElement::SimSecureElement::V1_0::ISecureElementInterface {
public:
    SecureElementInterfaceService() = default;
    virtual ~SecureElementInterfaceService() = default;
...
#endif // OHOS_HDI_SECURE_ELEMENT_SIM_SECURE_ELEMENT_V1_0_SECUREELEMENTINTERFACESERVICE_H