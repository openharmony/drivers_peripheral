 ...
 */
#ifndef OHOS_HDI_SECURE_ELEMENT_REMOTE_DEATH_RECIPIENT_H
#define OHOS_HDI_SECURE_ELEMENT_REMOTE_DEATH_RECIPIENT_H
...
#endif // OHOS_HDI_SECURE_ELEMENT_REMOTE_DEATH_RECIPIENT_H