...
{
    char absPath[DYNAMIC_LIB_PATH_MAX] = {0};
...
void InitAttrsCommon(struct AudioSampleAttributes &attrs)
{
    ...
    attrs.frameSize = AUDIO_FORMAT_PCM_BIT * AUDIO_CHANNELCOUNT / 8; /* divide 8 is for bit to byte */
    attrs.isBigEndian = false;
    attrs.isSignedData = true;
    /* DEEP_BUFFER_RENDER_PERIOD_SIZE / (16 * attrs->channelCount / 8) divide 8 is for bit to byte */
    attrs.startThreshold = DEEP_BUFFER_RENDER_PERIOD_SIZE / (AUDIO_FORMAT_PCM_BIT * AUDIO_CHANNELCOUNT / 8);
