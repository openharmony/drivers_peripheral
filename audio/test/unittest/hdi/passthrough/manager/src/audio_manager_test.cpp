...
HWTEST_F(AudioManagerTest, AudioManagerGetAllAdaptersWhenParamIsValid, TestSize.Level1)
{
    struct AudioManager *managerFuncs = GetAudioManagerFuncs();
    int32_t size = 0;
    struct AudioAdapterDescriptor *descs;
...
HWTEST_F(AudioManagerTest, AudioManagerLoadAdapterWhenParamIsValid, TestSize.Level1)
{
    int32_t ret;
    struct AudioManager *managerFuncs = GetAudioManagerFuncs();
    ASSERT_NE(managerFuncs, nullptr);
