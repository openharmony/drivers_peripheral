...
HWTEST_F(AudioAdapterTest, GetAudioRenderFuncWhenParamIsValid, TestSize.Level1)
{
...
HWTEST_F(AudioAdapterTest, CheckParaDescWhenParamIsValid, TestSize.Level1)
{
    struct AudioDeviceDescriptor desc;
    EXPECT_EQ(HDF_SUCCESS, InitDevDesc(desc));
    const char *type = "Render";
...
HWTEST_F(AudioAdapterTest, CheckParaAttrWhenParamIsValid, TestSize.Level1)
{
    struct AudioSampleAttributes attrs;
    EXPECT_EQ(HDF_SUCCESS,  InitAttrs(attrs));
...
HWTEST_F(AudioAdapterTest, AttrFormatToBitWhenParamIsValid, TestSize.Level1)
{
    struct AudioSampleAttributes attrs;
    EXPECT_EQ(HDF_SUCCESS, InitAttrs(attrs));
    int32_t format = -1;
...
HWTEST_F(AudioAdapterTest, InitHwRenderParamWhenParamIsValid, TestSize.Level1)
{
    struct AudioDeviceDescriptor desc;
    EXPECT_EQ(HDF_SUCCESS, InitDevDesc(desc));
    struct AudioSampleAttributes attrs;
...
HWTEST_F(AudioAdapterTest, AudioAdapterReleaseCapSubPortsWhenParamIsValid, TestSize.Level1)
{
...
HWTEST_F(AudioAdapterTest, AudioAdapterInitAllPortsWhenParamIsValid, TestSize.Level1)
{
...
HWTEST_F(AudioAdapterTest, AudioAdapterCreateRenderPreWhenParamIsValid, TestSize.Level1)
{
    struct AudioHwRender *hwRender = (struct AudioHwRender *)calloc(1, sizeof(*hwRender));
    ASSERT_NE(hwRender, nullptr);
    struct AudioDeviceDescriptor devDesc;
...
HWTEST_F(AudioAdapterTest, AudioAdapterCreateRenderWhenParamIsValid, TestSize.Level1)
{
    struct AudioDeviceDescriptor devDesc;
    EXPECT_EQ(HDF_SUCCESS, InitDevDesc(devDesc));
    struct AudioSampleAttributes attrs;
...
HWTEST_F(AudioAdapterTest, GetAudioCaptureFuncWhenParamIsValid, TestSize.Level1)
{
...
HWTEST_F(AudioAdapterTest, InitHwCaptureParamWhenParamIsValid, TestSize.Level1)
{
    struct AudioDeviceDescriptor desc;
    EXPECT_EQ(HDF_SUCCESS, InitDevDescCapture(desc));
    struct AudioSampleAttributes attrs;
...
HWTEST_F(AudioAdapterTest, AudioAdapterCreateCaptureWhenParamIsValid, TestSize.Level1)
{
    struct AudioDeviceDescriptor devDesc;
    EXPECT_EQ(HDF_SUCCESS, InitDevDescCapture(devDesc));
    struct AudioSampleAttributes attrs;
...
HWTEST_F(AudioAdapterTest, AudioAdapterGetPortCapabilityWhenParamIsValid, TestSize.Level1)
{
...
HWTEST_F(AudioAdapterTest, AudioAdapterSetPassthroughModeWhenParamIsValid, TestSize.Level1)
{
    ASSERT_EQ(AUDIO_HAL_SUCCESS, AudioAdapterInitAllPorts(adapter));
    struct AudioPort *port = desc->ports;
    AudioPortPassthroughMode mode = PORT_PASSTHROUGH_LPCM;
...
HWTEST_F(AudioAdapterTest, AudioAdapterSetPassthroughModeWhenModeIsError, TestSize.Level1)
{
    ASSERT_EQ(AUDIO_HAL_SUCCESS, AudioAdapterInitAllPorts(adapter));
    struct AudioPort *port = desc->ports;
    AudioPortPassthroughMode mode = PORT_PASSTHROUGH_RAW;
    EXPECT_EQ(AUDIO_HAL_ERR_INTERNAL, AudioAdapterSetPassthroughMode(adapter, port, mode));
}
...
HWTEST_F(AudioAdapterTest, AudioAdapterGetPassthroughModeWhenParamIsValid, TestSize.Level1)
{
    ASSERT_EQ(AUDIO_HAL_SUCCESS, AudioAdapterInitAllPorts(adapter));
    struct AudioPort *port = desc->ports;
    AudioPortPassthroughMode mode = PORT_PASSTHROUGH_LPCM;
