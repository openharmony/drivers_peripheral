...
TestGetAudioManager AudioIdlHdiRenderHardwareDependenceTest::getAudioManager = nullptr;
...
TestAudioManagerRelease AudioIdlHdiRenderHardwareDependenceTest::managerRelease = nullptr;
TestAudioAdapterRelease AudioIdlHdiRenderHardwareDependenceTest::adapterRelease = nullptr;
TestAudioRenderRelease AudioIdlHdiRenderHardwareDependenceTest::renderRelease = nullptr;
...
/**
    ...
    * @tc.author: liweiming
*/
HWTEST_F(AudioIdlHdiRenderHardwareDependenceTest, SUB_Audio_HDI_RenderGetFrameSize_005, TestSize.Level1)
{
    int32_t ret;
    uint64_t size = 0;
    struct AudioSampleAttributes attrs = {};
...
/**
    ...
    * @tc.author: liweiming
*/
HWTEST_F(AudioIdlHdiRenderHardwareDependenceTest, SUB_Audio_HDI_RenderGetFrameSize_007, TestSize.Level1)
{
    int32_t ret;
    uint64_t size = 0;
    struct AudioSampleAttributes attrs = {};
...
/**
    ...
    * @tc.author: liweiming
*/
HWTEST_F(AudioIdlHdiRenderHardwareDependenceTest, SUB_Audio_HDI_RenderGetFrameCount_006, TestSize.Level1)
{
    int32_t ret;
    uint64_t count = 0;
    struct AudioSampleAttributes attrs = {};
...
/**
    ...
    * @tc.author: liweiming
*/
HWTEST_F(AudioIdlHdiRenderHardwareDependenceTest, SUB_Audio_HDI_RenderGetFrameCount_007, TestSize.Level1)
{
    int32_t ret;
    uint64_t count = 0;
    struct AudioSampleAttributes attrs = {};
...
/**
    ...
    * @tc.author: liweiming
*/
HWTEST_F(AudioIdlHdiRenderHardwareDependenceTest, SUB_Audio_HDI_RenderGetCurrentChannelId_002, TestSize.Level1)
{
    int32_t ret;
...
/**
    * @tc.name    Test AudioRenderGetRenderPosition API via define sampleRate and channelCount to different value
    * @tc.number  SUB_Audio_HDI_RenderGetRenderPosition_011
    * @tc.desc    Test GetRenderPosition interface,return 0 if get framesize define channelCount as different values
    * @tc.author: liweiming
*/
HWTEST_F(AudioIdlHdiRenderHardwareDependenceTest, SUB_Audio_HDI_RenderGetRenderPosition_011, TestSize.Level1)
{
    int32_t ret;
    uint64_t frames = 0;
    int64_t timeExp = 0;
...
/**
    * @tc.name    Test AudioRenderGetRenderPosition API via define sampleRate and channelCount to 1
    * @tc.number  SUB_Audio_HDI_RenderGetRenderPosition_012
    * @tc.desc    Test GetRenderPosition interface,return 0 if get framesize define channelCount to 1
    * @tc.author: liweiming
*/
HWTEST_F(AudioIdlHdiRenderHardwareDependenceTest, SUB_Audio_HDI_RenderGetRenderPosition_012, TestSize.Level1)
{
    int32_t ret;
    uint64_t frames = 0;
    int64_t timeExp = 0;
...
* @tc.author: liweiming
*/
HWTEST_F(AudioIdlHdiRenderHardwareDependenceTest, SUB_Audio_HDI_RenderGetMmapPosition_002, TestSize.Level1)
{
    int32_t ret;
    uint64_t frames = 0;
    int64_t timeExp = 0;
