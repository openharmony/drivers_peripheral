...
void AudioLibRenderHardwareDependenceTest::SetUpTestCase(void)
{
    ...
    BindServiceRenderSo = reinterpret_cast<struct DevHandle* (*)(
        const char *serverName)>(dlsym(ptrHandle, "AudioBindServiceRender"));
    ...
    CloseServiceRenderSo = reinterpret_cast<void (*)(
        struct DevHandle *handle)>(dlsym(ptrHandle, "AudioCloseServiceRender"));
