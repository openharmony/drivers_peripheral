...
#include "audiogetcurrentchannelidcapture_fuzzer.h"
#include "audio_hdi_fuzzer_common.h"

using namespace OHOS::Audio;
namespace OHOS {
namespace Audio {
    bool AudioGetCurrentChannelidCaptureFuzzTest(const uint8_t *data, size_t size)
    {
        bool result = false;
...
{
    OHOS::Audio::AudioGetCurrentChannelidCaptureFuzzTest(data, size);
    return 0;
}