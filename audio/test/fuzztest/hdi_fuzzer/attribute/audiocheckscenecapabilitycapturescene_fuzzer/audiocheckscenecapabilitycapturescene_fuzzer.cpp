...
#include "audiocheckscenecapabilitycapturescene_fuzzer.h"
#include "audio_hdi_fuzzer_common.h"

using namespace OHOS::Audio;
namespace OHOS {
namespace Audio {
    bool AudioCheckSceneCapabilityCaptureSceneFuzzTest(const uint8_t *data, size_t size)
    {
        bool result = false;
...
{
    OHOS::Audio::AudioCheckSceneCapabilityCaptureSceneFuzzTest(data, size);
    return 0;
}