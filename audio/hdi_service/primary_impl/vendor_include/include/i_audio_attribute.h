...
#ifndef I_AUDIO_ATTRIBUTE_H
#define I_AUDIO_ATTRIBUTE_H
...
struct AudioHwiAttribute {
     ...
     */
    int32_t (*SetSampleAttributes)(AudioHandle handle, const struct AudioHwiSampleAttributes *attrs);
     ...
     */
    int32_t (*GetSampleAttributes)(AudioHandle handle, struct AudioHwiSampleAttributes *attrs);
     ...
     * @return Returns <b>0</b> if the operation is successful; returns a negative value otherwise.
     */
    int32_t (*ReqMmapBuffer)(AudioHandle handle, int32_t reqSize, struct AudioHwiMmapBufferDescriptor *desc);
     ...
     * @return Returns <b>0</b> if the operation is successful; returns a negative value otherwise.
     */
    int32_t (*GetMmapPosition)(AudioHandle handle, uint64_t *frames, struct AudioHwiTimeStamp *time);
