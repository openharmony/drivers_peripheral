...
#ifndef I_AUDIO_SCENE_H
#define I_AUDIO_SCENE_H
...
struct AudioHwiScene {
     ...
     * @see SelectScene
     */
    int32_t (*CheckSceneCapability)(AudioHandle handle, const struct AudioHwiSceneDescriptor *scene, bool *supported);
     ...
     */
    int32_t (*SelectScene)(AudioHandle handle, const struct AudioHwiSceneDescriptor *scene);
};

#endif /* I_AUDIO_SCENE_H */
/** @} */