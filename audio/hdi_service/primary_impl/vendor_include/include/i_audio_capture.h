...
#ifndef I_AUDIO_CAPTURE_H
#define I_AUDIO_CAPTURE_H
...
struct AudioHwiCapture {
     ...
     */
    int32_t (*CaptureFrame)(struct AudioHwiCapture *capture, void *frame, uint64_t requestBytes, uint64_t *replyBytes);
     ...
     * @see CaptureFrame
     */
    int32_t (*GetCapturePosition)(struct AudioHwiCapture *capture, uint64_t *frames, struct AudioHwiTimeStamp *time);
};

#endif /* I_AUDIO_CAPTURE_H */
/** @} */