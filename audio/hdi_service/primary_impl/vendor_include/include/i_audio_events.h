...
#ifndef I_AUDIO_EVENTS_H
#define I_AUDIO_EVENTS_H

#include <stdint.h>

typedef enum AudioHwiEventType {
...
typedef enum AudioHwiEventType EVENT_LOAD_TYPE;
typedef enum AudioHwiEventType EVENT_SERVICE_TYPE;

typedef enum AudioHwiDeviceType {
...
struct AudioHwiEvent {
    uint32_t eventType;
    uint32_t deviceType;
};

#endif /* I_AUDIO_EVENTS_H */
/** @} */