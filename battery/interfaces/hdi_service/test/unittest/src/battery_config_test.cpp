...
{
    ASSERT_TRUE(g_configTest.ParseConfig(VENDOR_BATTERY_CONFIG_PATH));
}
...
HWTEST_F (BatteryConfigTest, BatteryConfig009, TestSize.Level1)
{
    ...
    std::string currentPath = g_configTest.GetString("charger.current_limit.path");
    ASSERT_TRUE(!currentPath.empty());
    std::string voltagePath = g_configTest.GetString("charger.voltage_limit.path");
...
HWTEST_F (BatteryConfigTest, BatteryConfig010, TestSize.Level1)
{
    ...
    ASSERT_EQ("123", g_configTest.GetString("XXXXXXXXX", "123"));
...
HWTEST_F (BatteryConfigTest, BatteryConfig011, TestSize.Level1)
{
    ...
    ASSERT_EQ("", g_configTest.GetString("X.X.X.X.X.X"));
...
HWTEST_F (BatteryConfigTest, BatteryConfig012, TestSize.Level1)
{
    ...
    ASSERT_EQ("", g_configTest.GetString(""));
