...
{
    BATTERY_HILOGI(LABEL_TEST, "BatteryST_001 start.");
    ...
    BATTERY_HILOGI(LABEL_TEST, "BatteryST_001 end.");
}
...
{
    BATTERY_HILOGI(LABEL_TEST, "BatteryST_002 start.");
    std::string reason = "rebootTest";
    BatteryThreadTest btTest;
    ChargerThread ct;
    ...
    BATTERY_HILOGI(LABEL_TEST, "BatteryST_0022 end.");
}
}
