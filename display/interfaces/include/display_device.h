 ...
 *
 * @param devId Indicates the ID of the display device. This ID is generated by the HDI implementation layer and transferred to the graphics service through the current callback. It identifies the display device to connect.
 * @param connected Indicates the connection status of the display device. The value <b>true</b> means that the display device is connected, and <b>false</b> means the opposite.
 * @param data Indicates the private data carried by the graphics service. This parameter carries the private data address transferred when <b>RegHotPlugCallback</b> is called. For details, see {@link RegHotPlugCallback}.
 *  
 *
 * @since 1.0
 * @version 1.0
...
typedef struct {
     ...
     * @param data Indicates the pointer to the private data returned to the graphics service in the <b>HotPlugCallback</b> callback.
     *
     * @return Returns <b>0</b> if the operation is successful; returns an error code defined in {@link DispErrCode} otherwise.
     * @since 1.0
     * @version 1.0
     */
     ...
     *
     * @param devId Indicates the ID of the display device.
     * @param callback Indicates the instance used to notify the graphics service of the VBLANK event occurred when <b>DisplayVsync</b> is enabled.
     * @param data Indicates the pointer to the private data returned to the graphics service in the <b>VBlankCallback</b> callback.
     *
     * @return Returns <b>0</b> if the operation is successful; returns an error code defined in {@link DispErrCode} otherwise.
     * @since 1.0
     * @version 1.0
     ...
     *
     * @param devId Indicates the ID of the display device.
     * @param callback Indicates the instance used to notify the graphics service of the request for refreshing data frames.
     * @param data Indicates the pointer to the private data returned to the graphics service in the <b>RefreshCallback</b> callback.
     *
     * @return Returns <b>0</b> if the operation is successful; returns an error code defined in {@link DispErrCode} otherwise.
     * @since 1.0
     * @version 1.0
     ...
     *
     * @param devId Indicates the ID of the display device.
     * @param info Indicates the pointer to the capabilities supported by the display device. For details, see {@link DisplayCapability}.
     *
     * @return Returns <b>0</b> if the operation is successful; returns an error code defined in {@link DispErrCode} otherwise.
     * @since 1.0
     * @version 1.0
     ...
     * @param modes Indicates the pointer to the information about all modes supported by the display device, including all supported resolutions and refresh rates. Each mode has an ID, which will be used when
     ...
     *
     * @param devId Indicates the ID of the display device.
     * @param modeId indicates the pointer to the ID of the current display mode of the device. The display mode ID is written by this API.
     *
     * @since 1.0
     * @version 1.0
     */
     ...
     *
     * @param devId Indicates the ID of the display device.
     * @param modeId Indicates the ID of the display mode. The device is switched to the display mode specified by this parameter in this interface.
     *
     * @return Returns <b>0</b> if the operation is successful; returns an error code defined in {@link DispErrCode} otherwise.
     * @since 1.0
     * @version 1.0
     ...
     *
     * @param devId Indicates the ID of the display device.
     * @param level Indicates the pointer to the backlight value of the device. The backlight value is written by this interface. 
     *
     * @return Returns <b>0</b> if the operation is successful; returns an error code defined in {@link DispErrCode} otherwise.
     * @since 1.0
     * @version 1.0
     ...
     * @param level Indicates the pointer to the property corresponding to the property ID. The property value is written by this interface. 
     *
     * @return Returns <b>0</b> if the operation is successful; returns an error code defined in {@link DispErrCode} otherwise.
     * @since 1.0
     * @version 1.0
    ...
    *
    * Before the composition, the graphics service needs to notify the display device of the preparation to be made through this interface.
    *
    * @param devId Indicates the ID of the display device.
    * @param needFlushFb Indicates the pointer that specifies whether the graphics service needs to reset the display framebuffer by using <b>SetDisplayClientBuffer</b> before the commit operation.
    ...
    */
     ...
     *
     * In the preparation for composition, the display device changes the composition type for each layer based on the composition capability of the device. This function returns the layers whose composition types have changed.
     *
     * @param devId Indicates the ID of the display device.
     ...
     *
     * You can use this interface to set the cropped region of the client buffer of the display device. The cropped region cannot exceed the size of the client buffer.
     *
     * @param devId Indicates the ID of the display device.
     ...
     * @param fence Indicates the sync fence that specifies whether the display buffer can be accessed. The display buffer is created and released by the graphics service. It can be accessed only when the sync fence is in the signaled state.
     *
     * @return Returns <b>0</b> if the operation is successful; returns an error code defined in {@link DispErrCode} otherwise.
     * @since 1.0
     * @version 1.0
     ...
     *
     * The dirty region consists of multiple rectangular regions. The rectangular regions can be refreshed based on the settings.
     *
     * @param devId Indicates the ID of the display device.
     ...
     *
     * When the vertical sync signal is generated, the <b>VBlankCallback</b> callback registered by <b>RegDisplayVBlankCallback</b>
     * will be invoked.
     * The vertical sync signal must be enabled when the graphics service needs to refresh the display, and disabled when display refresh is not required. The display does not need to refresh when <b>VBlankCallback</b> is invoked and the graphics service composes layers and sends the composition result to the device for display. 
     * @param devId Indicates the ID of the display device.
     * @param enabled Specifies whether to enable the vertical sync signal. The value <b>true</b> means to enable the vertical sync signal, and <b>false</b> means to disable it.
     *
     * @return Returns <b>0</b> if the operation is successful; returns an error code defined in {@link DispErrCode} otherwise.
     * @since 1.0
     * @version 1.0
     ...
     *
     * If there is a hardware composition layer, the composition is performed and the composition result is sent to the hardware for display.
     *
     *
     * @param devId Indicates the ID of the display device.
     * @param num Indicates the pointer to the number of layers.
     ...
     *
     * This function extends the APIs between the graphics service and implementation layer, eliminating the need to add new APIs.
     *
     *
     * @param devId Indicates the ID of the display device.
     *
     ...
     *
     * This buffer stores the output of the virtual display device. The buffer can be used only after the sync fence is in the signaled state.
     *
     * @param devId Indicates the ID of the display device.
     ...
     *
     * This function is used to obtain data of the writeback endpoint specified by <b>devId</b>. The data is written to the specified buffer by this interface.
     *
     * @param devId Indicates the ID of the display device.
     * @param buffer Indicates the pointer to the buffer of the writeback endpoint data.
     * @param fence Indicates the pointer to the sync fence. When calling this interface, the graphics service needs to pass the <b>release fence</b> of the buffer to
     * specify whether data can be written to the buffer. Then, <b>acquire fence</b> of the buffer needs to be written and sent to
     * the graphics service to specify whether the writeback data has been written to the buffer.
     *
     * @return Returns <b>0</b> if the operation is successful; returns an error code defined in {@link DispErrCode} otherwise.
     * @since 1.0
     * @version 1.0
     ...
     *
     * @param devId Indicates the pointer to the ID of the display device. After a writeback endpoint is created, the device ID of the writeback endpoint is written in this parameter and returned to the graphics service.
     * @param width Indicates the writeback pixel width.
     * @param height Indicates the writeback pixel height.
     * @param format Indicates the pointer to the writeback point data format. For details, see {@link PixelFormat}. The <b>format</b> can be modified based on hardware requirements and returned to the graphics service.
     *
     * @return Returns <b>0</b> if the operation is successful; returns an error code defined in {@link DispErrCode} otherwise.
     * @since 1.0
     * @version 1.0
 ...
 * the control functions will be released. In other words, the memory allocated during initialization of the control functions will be released.
 *
