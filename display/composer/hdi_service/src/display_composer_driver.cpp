...
#include "v1_5/display_composer_stub.h"
...
static int HdfDisplayComposerDriverBind(struct HdfDeviceObject* deviceObject)
{
    ...
    auto serviceImpl = OHOS::HDI::Display::Composer::V1_5::IDisplayComposer::Get(true);
    ...
    hdfDisplayComposerHost->stub = OHOS::HDI::ObjectCollector::GetInstance().GetOrNewObject(serviceImpl,
        OHOS::HDI::Display::Composer::V1_5::IDisplayComposer::GetDescriptor());
