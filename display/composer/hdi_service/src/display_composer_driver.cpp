...
#include "v1_4/display_composer_stub.h"
...
static int HdfDisplayComposerDriverBind(struct HdfDeviceObject* deviceObject)
{
    ...
    auto serviceImpl = OHOS::HDI::Display::Composer::V1_4::IDisplayComposer::Get(true);
    ...
    hdfDisplayComposerHost->stub = OHOS::HDI::ObjectCollector::GetInstance().GetOrNewObject(serviceImpl,
        OHOS::HDI::Display::Composer::V1_4::IDisplayComposer::GetDescriptor());
