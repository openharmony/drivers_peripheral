...
#ifndef _DISPLAY_COMPOSER_HWI_IMPL_H
#define _DISPLAY_COMPOSER_HWI_IMPL_H
...
class DisplayComposerHwiImpl : public IDisplayComposerHwi {
public:
    DisplayComposerHwiImpl();
    virtual ~DisplayComposerHwiImpl();
    // *** device func
...
#endif // _DISPLAY_COMPOSER_HWI_IMPL_H
