...
#ifndef OHOS_HDI_DISPLAY_V1_0_IDISPLAYCOMPOSERHWI_H
...
#define DISPLAY_COMPOSER_HWI_LIBRARY_PATH "/vendor/lib/libdisplay_composer_hwi_impl.z.so"
class IDisplayComposerHwi {
public:
    virtual ~IDisplayComposerHwi() = default;
    // *** device func
    ...
    virtual int32_t SetLayerDirtyRegion(uint32_t devIdHWI, uint32_t layerId,
...
typedef IDisplayComposerHwi* CreateComposerHwiFunc_t();
extern "C" IDisplayComposerHwi* CreateComposerHwi();
typedef void DestroyComposerHwiFunc_t(IDisplayComposerHwi*);
...
#endif // OHOS_HDI_DISPLAY_V1_0_IDISPLAYCOMPOSERHWI_H
