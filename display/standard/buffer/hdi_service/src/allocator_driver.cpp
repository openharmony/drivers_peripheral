...
{
    HDF_LOGI("HdfAllocatorDriverInit enter");
    return HDF_SUCCESS;
}

static int HdfAllocatorDriverBind(struct HdfDeviceObject *deviceObject)
{
    HDF_LOGI("HdfAllocatorDriverBind enter");
...
{
    HDF_LOGI("HdfAllocatorDriverRelease enter");
    if (deviceObject->service == nullptr) {
        HDF_LOGE("HdfAllocatorDriverRelease not initted");
        return;
    }
