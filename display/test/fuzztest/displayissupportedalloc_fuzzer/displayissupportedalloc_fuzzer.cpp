...
#include "displayissupportedalloc_fuzzer.h"
...
namespace OHOS {
    bool DisplayIssupportedAllocFuzzTest(const uint8_t* data, size_t size)
    {
        bool result = false;
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::DisplayIssupportedAllocFuzzTest(data, size);
    return 0;
}
