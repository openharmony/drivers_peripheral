...
#include "vibratorplaypatternbysessionid_fuzzer.h"
#include "hdf_base.h"
...
namespace OHOS {
    bool VibratorPlayPatternBySessionIdTest(const uint8_t* data, size_t size)
    {
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::VibratorPlayPatternBySessionIdTest(data, size);
    return 0;
}
