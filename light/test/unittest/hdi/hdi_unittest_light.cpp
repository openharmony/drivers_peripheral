...
{
    HDF_LOGI("%{public}s in", testing::UnitTest::GetInstance()->current_test_info()->name());
    ASSERT_NE(nullptr, g_lightInterface);
...
/**
  * @tc.name: TurnOnLightGradientException003
  * @tc.desc: The offtime setting is abnormal in gradient mode.
  * @tc.type: FUNC
  * @tc.require: #IAU5KS
  */
HWTEST_F(HdiUnitTestLight, TurnOnLightGradientException003, TestSize.Level1)
{
    TEST_FUNC_IN;
    ASSERT_NE(nullptr, g_lightInterface);
...
/**
  * @tc.name: TurnOnLightGradientException004
  * @tc.desc: The offtime setting is abnormal in gradient mode.
  * @tc.type: FUNC
  * @tc.require: #IAU5KS
  */
HWTEST_F(HdiUnitTestLight, TurnOnLightGradientException004, TestSize.Level1)
{
    TEST_FUNC_IN;
    ASSERT_NE(nullptr, g_lightInterface);
...
/**
  * @tc.name: TurnOnLightGradientException005
  * @tc.desc: The offtime setting is abnormal in gradient mode.
  * @tc.type: FUNC
  * @tc.require: #IAU5KS
  */
HWTEST_F(HdiUnitTestLight, TurnOnLightGradientException005, TestSize.Level1)
{
    TEST_FUNC_IN;
    ASSERT_NE(nullptr, g_lightInterface);
