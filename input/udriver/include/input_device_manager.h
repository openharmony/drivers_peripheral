...
public:
    ...
    int32_t GetDevice(int32_t deviceIndex, InputDeviceInfo **devInfo);
    int32_t GetDeviceList(uint32_t *devNum, InputDeviceInfo **deviceList, uint32_t size);
    // InputController
