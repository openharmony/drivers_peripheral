...
#include "usbd_async_interrupt_transfer_test.h"
...
namespace OHOS::USB::UsbdAsyncInterruptTransfer {

UsbDev UsbdAsyncInterruptTransferTest::dev_ = {0, 0};
sptr<UsbSubscriberTest> UsbdAsyncInterruptTransferTest::subscriber_ = nullptr;
...
void UsbdAsyncInterruptTransferTest::SetUpTestCase(void)
{
...
void UsbdAsyncInterruptTransferTest::TearDownTestCase(void)
{
    ...
    HDF_LOGI("UsbdAsyncInterruptTransferTest:: %{public}d Close=%{public}d", __LINE__, ret);
    ASSERT_EQ(0, ret);
}

void UsbdAsyncInterruptTransferTest::SetUp(void) {}

void UsbdAsyncInterruptTransferTest::TearDown(void) {}

void UsbdAsyncInterruptTransferTest::SubscriberEvent()
{
    ...
    HDF_LOGI("UsbdAsyncInterruptTransferTest:: %{public}d OpenDevice=%{public}d", __LINE__, ret);
    ASSERT_EQ(0, ret);
}
 ...
 * @tc.type: FUNC
 */
HWTEST_F(UsbdAsyncInterruptTransferTest, InterruptRead001, TestSize.Level1)
{
    ...
    HDF_LOGI("UsbdAsyncTransferTest::InterruptRead001 %{public}d UsbSubmitTransfer=%{public}d", __LINE__, ret);
    EXPECT_EQ(ret, 0);
 ...
 * @tc.type: FUNC
 */
HWTEST_F(UsbdAsyncInterruptTransferTest, InterruptWrite001, TestSize.Level1)
{
...
/**
 * @tc.name: CancelInterruptTransfer001
 ...
 * @tc.type: FUNC
 */
HWTEST_F(UsbdAsyncInterruptTransferTest, CancelInterruptTransfer001, TestSize.Level1)
{
    HDF_LOGI("Case Start: CancelInterruptTransfer001");
    struct UsbDev dev = dev_;
    struct USBTransferInfo info = {
        .endpoint = ENDPOINT_ADDRESS_IN,
        .flags = 0,
    ...
    for (int i = 0; i < 10; i++) {
        ...
        HDF_LOGI("UsbdAsyncInterruptTransfer::CancelInterruptTransfer001 %{public}d UsbSubmitTransfer=%{public}d",
            __LINE__, submitTransferRet);
    }
    auto cancelTransferRet = g_usbInterface->UsbCancelTransfer(dev, ENDPOINT_ADDRESS_IN);
    HDF_LOGI("UsbdAsyncInterruptTransfer::CancelInterruptTransfer001 %{public}d UsbCancelTransfer=%{public}d",
    ...
    HDF_LOGI("Case End: CancelInterruptTransfer001");
}

/**
 * @tc.name: CancelInterruptTransfer002
 ...
 * @tc.type: FUNC
 */
HWTEST_F(UsbdAsyncInterruptTransferTest, CancelInterruptTransfer002, TestSize.Level1)
{
    HDF_LOGI("Case Start: CancelInterruptTransfer002");
    ...
    EXPECT_NE(ret, 0);
    HDF_LOGI("Case End: CancelInterruptTransfer002");
}
 ...
 * @tc.type: FUNC
 */
HWTEST_F(UsbdAsyncInterruptTransferTest, CancelInterruptTransfer003, TestSize.Level1)
{
    HDF_LOGI("Case Start: CancelInterruptTransfer003");
    std::shared_ptr<LibusbAdapter> adapter = LibusbAdapter::GetInstance();
    UsbDev device_ = dev_;
    ...
    int32_t ret = adapter->AsyncCancelTransfer(device_, errEndPoint);
    EXPECT_NE(ret, 0);
    HDF_LOGI("Case End: CancelInterruptTransfer003");
}
 ...
 * @tc.type: FUNC
 */
HWTEST_F(UsbdAsyncInterruptTransferTest, AsyncSubmitTransfer001, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(UsbdAsyncInterruptTransferTest, AsyncSubmitTransfer002, TestSize.Level1)
{
 ...
 * @tc.type: FUNC
 */
HWTEST_F(UsbdAsyncInterruptTransferTest, AsyncSubmitTransfer003, TestSize.Level1)
{
