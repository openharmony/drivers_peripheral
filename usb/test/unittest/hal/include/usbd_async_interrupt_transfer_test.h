 ...
 */
#ifndef USBD_ASYNC_INTERRUPT_TRANSFER_TEST_H
#define USBD_ASYNC_INTERRUPT_TRANSFER_TEST_H
...
namespace OHOS {
namespace USB {
namespace UsbdAsyncInterruptTransfer {
class UsbdAsyncInterruptTransferTest : public testing::Test {
public:
...
#endif // USBD_ASYNC_INTERRUPT_TRANSFER_TEST_H
