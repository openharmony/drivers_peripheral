 ...
 */
#ifndef USBD_INTERFACE_AUTHORIZE_TEST_H
#define USBD_INTERFACE_AUTHORIZE_TEST_H
...
class UsbInterfaceAuthorizeTest : public testing::Test {
public:
...
#endif // USBD_INTERFACE_AUTHORIZE_TEST_H