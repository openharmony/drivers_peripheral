 ...
 */
#ifndef USBD_INTERRUPT_TRANSFER_TEST_H
#define USBD_INTERRUPT_TRANSFER_TEST_H
...
namespace OHOS {
namespace USB {
namespace UsbdInterruptTransfer {
class UsbdInterruptTransferTest : public testing::Test {
public:
...
#endif // USBD_INTERRUPT_TRANSFER_TEST_H
