...
#ifndef USB_SERIAL_LITEOS_ADAPTER_H
#define USB_SERIAL_LITEOS_ADAPTER_H
...
class LiteOsUsbSerialOsAdapter : public UsbSerialOsAdapter {
public:
    LiteOsUsbSerialOsAdapter() = default;
    virtual ~LiteOsUsbSerialOsAdapter() = default;
