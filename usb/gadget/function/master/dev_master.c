...
static struct UsbSsEpCompDescriptor g_ssEcmBulkCompDesc = {
    .bLength = sizeof(g_ssEcmBulkCompDesc), .bDescriptorType = USB_DDK_DT_SS_ENDPOINT_COMP,
...
static struct UsbString g_acmStringDefs[] = {
    [0].s = "CDC Abstract Control Model (ACM)", [0x01].s = "CDC ACM Data", [0x02].s = "CDC Serial", {} /* end of list */
};
