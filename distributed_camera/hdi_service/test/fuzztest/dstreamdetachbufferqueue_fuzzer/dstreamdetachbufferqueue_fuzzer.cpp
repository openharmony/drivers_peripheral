...
#include "dstreamdetachbufferqueue_fuzzer.h"
...
void DstreamDetachBufferQueueFuzzTest(const uint8_t* data, size_t size)
{
    ...
    dCameraStreamOperator->DetachBufferQueue(streamId);
}
}
}
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::DistributedHardware::DstreamDetachBufferQueueFuzzTest(data, size);
    return 0;
}
