...
#include "dstreamattachbufferqueue_fuzzer.h"
...
void DstreamAttachBufferQueueFuzzTest(const uint8_t* data, size_t size)
{
    ...
    dCameraStreamOperator->AttachBufferQueue(streamId, bufferProducer);
}
}
}
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::DistributedHardware::DstreamAttachBufferQueueFuzzTest(data, size);
    return 0;
}
