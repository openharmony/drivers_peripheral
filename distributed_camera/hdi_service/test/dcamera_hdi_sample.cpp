...
static const std::string TEST_DEV_ID = "11111111111111111111111111111111";
static const std::string TEST_CAM_ID = "camera_0";
static const std::string TEST_ATTR = R"({"CodecType": ["avenc_mpeg4"],
