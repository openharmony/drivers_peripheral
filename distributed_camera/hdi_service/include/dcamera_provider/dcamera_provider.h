...
public:
    ...
    bool IsForceSwitch();
    int32_t GetSystemSwitchRotation();
    int32_t SetForceSwitch(bool isSystemSwitch, int32_t systemSwitchRotation);
...
private:
    ...
    bool isSystemSwitch_;
    int32_t systemSwitchRotation_;
};
} // namespace DistributedHardware
} // namespace OHOS
