...
const uint32_t MAX_SUPPORT_PREVIEW_HEIGHT = 1920;
...
const uint32_t OHOS_CONTROL_REQUEST_CAMERA_SWITCH = 268435515;
const uint32_t OHOS_CONTROL_CAMERA_SWITCH_INFOS = 268435516;
