...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiDeviceTest, Camera_Hdi_0050, TestSize.Level0)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiDeviceTest, Camera_Hdi_0051, TestSize.Level2)
{
    std::cout << "==========[test log]Check hdi_device: GetStreamOprator, normal callback input." << std::endl;
    Test_->Open();
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiDeviceTest, Camera_Hdi_0060, TestSize.Level0)
{
    ...
    int32_t expo = 0xa0;
    auto ret = meta->addEntry(OHOS_CONTROL_AE_EXPOSURE_COMPENSATION, &expo, 1);
    EXPECT_EQ(ret, true);
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiDeviceTest, Camera_Hdi_0061, TestSize.Level2)
{
    std::cout << "==========[test log]Check hdi_device: UpdateSettings, ";
    ...
    std::shared_ptr<Camera::CameraSetting> meta = std::make_shared<Camera::CameraSetting>(100, 2000);
    auto ret = meta->addEntry(OHOS_CONTROL_AWB_MODE, &awbMode, 1);
    EXPECT_EQ(ret, true);
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiDeviceTest, Camera_Hdi_0062, TestSize.Level2)
{
    std::cout << "==========[test log]Check hdi_device: UpdateSettings, ";
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiDeviceTest, Camera_Hdi_0063, TestSize.Level2)
{
    std::cout << "==========[test log]Check hdi_device: UpdateSettings,";
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiDeviceTest, Camera_Hdi_0065, TestSize.Level2)
{
    std::cout << "==========[test log]Check hdi_device: UpdateSettings,";
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiDeviceTest, Camera_Hdi_0066, TestSize.Level2)
{
    std::cout << "==========[test log]Check hdi_device: UpdateSettings,";
    ...
    Test_->rc = Test_->cameraDevice->UpdateSettings(meta);
    EXPECT_EQ(Test_->rc, HDI::Camera::V1_0::NO_ERROR);
    sleep(2);
    // Release stream
    Test_->captureIds = {Test_->captureId_preview};
    Test_->streamIds = {Test_->streamId_preview};
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiDeviceTest, Camera_Hdi_0067, TestSize.Level2)
{
    std::cout << "==========[test log]Check hdi_device: UpdateSettings,";
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiDeviceTest, Camera_Hdi_0068, TestSize.Level2)
{
    std::cout << "==========[test log]Check hdi_device: UpdateSettings,";
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiDeviceTest, Camera_Hdi_0070, TestSize.Level0)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiDeviceTest, Camera_Hdi_0071, TestSize.Level2)
{
    Test_->Open();
    EXPECT_EQ(true, Test_->cameraDevice != nullptr);
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiDeviceTest, Camera_Hdi_0080, TestSize.Level0)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiDeviceTest, Camera_Hdi_0090, TestSize.Level0)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiDeviceTest, Camera_Hdi_0091, TestSize.Level2)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiDeviceTest, Camera_Hdi_0092, TestSize.Level2)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiDeviceTest, Camera_Hdi_0100, TestSize.Level0)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiDeviceTest, Camera_Hdi_0101, TestSize.Level2)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiDeviceTest, Camera_Hdi_0102, TestSize.Level2)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiDeviceTest, Camera_Hdi_0110, TestSize.Level0)
{
