...
camera_host_service_1.0=$(stat -c %s "libcamera_host_service_1.0.z.so")
echo "libcamera_host_service_1.0.z.so(B): "$camera_host_service_1.0
...
total=$[libcamera_client+camera_buffer_manager+camera_device_manager+camera_host_service_1.0+camera_pipeline_core+camera_utils]
