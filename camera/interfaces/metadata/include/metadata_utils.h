...
public:
    ...
    static std::string EncodeToString(std::shared_ptr<Camera::CameraMetadata> metadata);
    static std::shared_ptr<Camera::CameraMetadata> DecodeFromString(std::string setting);
