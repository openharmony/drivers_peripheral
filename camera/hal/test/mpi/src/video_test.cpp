...
/**
  * @tc.name: Video
  * @tc.desc: Preview + video streams, mock device power down, then Preview and video again.
  * @tc.size: MediumTest
  * @tc.type: Function
  */
HWTEST_F(VideoTest, Camera_Video_0006, TestSize.Level3)
{
    std::cout << "==========[test log]Check video: mock device power down, then Preview and video again."<< std::endl;
    EXPECT_EQ(1, 0);
}

/**
  * @tc.name: Video
  * @tc.desc: Video start&stop, for 100 times, success.
  * @tc.size: MediumTest
  * @tc.type: Function
  */
HWTEST_F(VideoTest, Camera_Video_0010, TestSize.Level3)
{
    std::cout << "==========[test log]Check video: Video start&stop, for 100 times, success." << std::endl;
    for (int i = 0; i < 100; i ++) {
        // 配置两路流信息
        Test_->intents = {Camera::PREVIEW, Camera::VIDEO};
        Test_->StartStream(Test_->intents);
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(VideoTest, Camera_Video_0011, TestSize.Level3)
{
