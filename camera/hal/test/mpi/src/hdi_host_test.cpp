...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiHostTest, Camera_Hdi_0010, TestSize.Level0)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiHostTest, Camera_Hdi_0020, TestSize.Level0)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiHostTest, Camera_Hdi_0021, TestSize.Level2)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiHostTest, Camera_Hdi_0022, TestSize.Level2)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiHostTest, Camera_Hdi_0030, TestSize.Level0)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiHostTest, Camera_Hdi_0031, TestSize.Level2)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiHostTest, Camera_Hdi_0032, TestSize.Level2)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiHostTest, Camera_Hdi_0033, TestSize.Level2)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiHostTest, Camera_Hdi_0034, TestSize.Level2)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiHostTest, Camera_Hdi_0035, TestSize.Level2)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiHostTest, Camera_Hdi_0040, TestSize.Level0)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiHostTest, Camera_Hdi_0041, TestSize.Level2)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiHostTest, Camera_Hdi_0042, TestSize.Level2)
{
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiHostTest, Camera_Hdi_0043, TestSize.Level2)
{
    std::cout << "==========[test log]Check hdi_host: SetFlashlight, normal cameraId." << std::endl;
    if (Test_->cameraDevice == nullptr) {
        Test_->service->GetCameraIds(Test_->cameraIds);
...
/**
  ...
  * @tc.type: Function
  */
HWTEST_F(HdiHostTest, Camera_Hdi_0044, TestSize.Level2)
{
    std::cout << "==========[test log]Check hdi_host: SetFlashlight, normal cameraId." << std::endl;
    if (Test_->cameraDevice == nullptr) {
        Test_->service->GetCameraIds(Test_->cameraIds);
