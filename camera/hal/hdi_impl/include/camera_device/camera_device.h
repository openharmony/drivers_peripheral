...
public:
    ...
    virtual RetCode GetMetadataResults(std::shared_ptr<Camera::CameraMetadata> &metadata) = 0;
...
protected:
    virtual void OnMetadataChanged(const std::shared_ptr<Camera::CameraMetadata> &metadata) = 0;
