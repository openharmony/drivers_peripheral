...
public:
    ...
    virtual ~IManager();
    virtual void Configure(std::shared_ptr<Camera::CameraMetadata> meta) = 0;
    ...
    virtual RetCode GetAbilityMetaData(std::shared_ptr<Camera::CameraMetadata> meta)
    {
        (void)meta;
        return RC_OK;
    }
    virtual RetCode GetAbilityMetaData(std::shared_ptr<Camera::CameraMetadata> meta, std::string hardwareName)
    {
        (void)meta;
        (void)hardwareName;
        return RC_OK;
