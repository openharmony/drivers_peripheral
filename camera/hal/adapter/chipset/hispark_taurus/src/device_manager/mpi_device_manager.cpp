        ...
        if (CheckManagerList((*iter).managerId) == false) {
            ...
            switch ((*iter).managerId) {
                case DM_M_VENC:
                    ...
                    if (manager == nullptr) {
                        CAMERA_LOGE("Create VencManager fail");
                        return RC_ERROR;
                    }
                ...
                case DM_M_VI:
                    ...
                    if (manager == nullptr) {
                        CAMERA_LOGE("Create ViManager fail");
                        return RC_ERROR;
                    }
                    break;
                case DM_M_VO:
                    ...
                    if (manager == nullptr) {
                        CAMERA_LOGE("Create VoManager fail");
                        return RC_ERROR;
                    }
                ...
                case DM_M_VPSS:
                    ...
                    if (manager == nullptr) {
                        CAMERA_LOGE("Create VpssManager fail");
                        return RC_ERROR;
                    }
...
void MpiDeviceManager::BufferCallback(std::shared_ptr<FrameSpec> buffer)
{
    ...
    std::shared_ptr<CameraStandard::CameraMetadata> meta = std::make_shared<CameraStandard::CameraMetadata>(ENTRY_CAPACITY, DATA_CAPACITY);
    RetCode rc;
    bool sendFlag = false;
