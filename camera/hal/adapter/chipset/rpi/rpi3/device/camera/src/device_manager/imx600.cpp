...
void Imx600::InitPhysicalSize(CameraMetadata& camera_meta_data)
{
    ISensor::InitPhysicalSize(camera_meta_data);
}

void Imx600::InitAntiBandingModes(CameraMetadata& camera_meta_data)
{
    ISensor::InitAntiBandingModes(camera_meta_data);
}

void Imx600::InitAeFpsTarget(CameraMetadata& camera_meta_data)
{
...
void Imx600::InitCompensationRange(CameraMetadata& camera_meta_data)
{
    ISensor::InitCompensationRange(camera_meta_data);
}

void Imx600::InitSensitivityRange(CameraMetadata& camera_meta_data)
{
    ISensor::InitSensitivityRange(camera_meta_data);
}

void Imx600::Init(CameraMetadata& camera_meta_data)
{
