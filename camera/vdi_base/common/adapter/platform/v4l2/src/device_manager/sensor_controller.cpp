    ...
    std::shared_ptr<CameraMetadata> meta, const int32_t &value)
{
    ...
    CAMERA_LOGI("Get CMD_FOCUS_MODE [%u]", focusMode);
    ...
    const int32_t &value)
{
    ...
    CAMERA_LOGI("Get CMD_FOCUS_SATE [%u]", focusState);
    std::lock_guard<std::mutex> lock(sensorController->metaDataFlaglock_);
    sensorController->metaDataFlag_ = true;
    ...
    std::shared_ptr<CameraMetadata> meta, const int32_t &value)
{
    ...
    CAMERA_LOGI("Get CMD_FEXPOSURE_MODE [%u]", exposureMode);
    std::lock_guard<std::mutex> lock(sensorController->metaDataFlaglock_);
    sensorController->metaDataFlag_ = true;
    ...
    std::shared_ptr<CameraMetadata> meta, const int32_t &value)
{
    ...
    CAMERA_LOGI("Get CMD_FEXPOSURE_TIME [%d]", exposureTime);
    std::lock_guard<std::mutex> lock(sensorController->metaDataFlaglock_);
    sensorController->metaDataFlag_ = true;
    ...
    std::shared_ptr<CameraMetadata> meta, const int32_t &value)
{
    ...
    CAMERA_LOGI("Get CMD_FEXPOSURE_COMPENSATION [%d]", exposureCompensation);
    std::lock_guard<std::mutex> lock(sensorController->metaDataFlaglock_);
    sensorController->metaDataFlag_ = true;
    ...
    std::shared_ptr<CameraMetadata> meta, const int32_t &value)
{
    ...
    CAMERA_LOGI("Get CMD_METER_MODE [%u]", meterMode);
    std::lock_guard<std::mutex> lock(sensorController->metaDataFlaglock_);
    sensorController->metaDataFlag_ = true;
    ...
    std::shared_ptr<CameraMetadata> meta, const int32_t &value)
{
    ...
    CAMERA_LOGI("Get CMD_EXPOSURE_STATE [%u]", exposureState);
    std::lock_guard<std::mutex> lock(sensorController->metaDataFlaglock_);
    sensorController->metaDataFlag_ = true;
    ...
    std::shared_ptr<CameraMetadata> meta, const int32_t &value)
{
    ...
    CAMERA_LOGI("Get CMD_FLASH_MODE [%u]", flashMode);
    std::lock_guard<std::mutex> lock(sensorController->metaDataFlaglock_);
    sensorController->metaDataFlag_ = true;
    ...
    std::shared_ptr<CameraMetadata> meta, const int32_t &value)
{
    ...
    CAMERA_LOGI("Get CMD_CAPTURE_MIRROR [%u]", captureMirror);
    std::lock_guard<std::mutex> lock(sensorController->metaDataFlaglock_);
    sensorController->metaDataFlag_ = true;
