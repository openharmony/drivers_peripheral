...
#ifdef RETURN_TIMEOUT
    // default:300ms,valid range (500, 5000], data can be defined via config.json
    auto timeout = std::chrono::system_clock::now() + std::chrono::microseconds(1000 * RETURN_TIMEOUT);
#else
