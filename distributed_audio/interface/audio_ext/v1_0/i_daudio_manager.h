...
public:
    virtual int32_t RegisterAudioDevice(std::string devId, std::string dhId, struct AudioParameter &param,
        IDAudioHDFCallback callback) = 0;
