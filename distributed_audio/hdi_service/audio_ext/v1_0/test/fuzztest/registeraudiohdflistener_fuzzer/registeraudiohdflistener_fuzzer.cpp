...
#include "registeraudiohdflistener_fuzzer.h"
...
void RegisterAudioHdfListenerFuzzTest(const uint8_t* data, size_t size)
{
    ...
    sptr<IDAudioHdfCallback> callbackObj = nullptr;
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t* data, size_t size)
{
    ...
    OHOS::HDI::DistributedAudio::Audioext::V3_0::RegisterAudioHdfListenerFuzzTest(data, size);
    return 0;
}
