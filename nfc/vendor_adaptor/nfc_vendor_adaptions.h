...
const std::string EXT_UPDATE_NFC_OPEN_STATUS = "UpdateNfcOpenStatus";
const std::string EXT_CHECK_NFC_BOOTLOADER_STATUS = "CheckNfcBootloaderStatus";
...
// 0:open 1:close 2:opening
const std::string NFC_OPEN_STATUS = "0";
const std::string NFC_CLOSE_STATUS = "1";
const std::string NFC_OPENING_STATUS = "2";
...
struct NfcExtInterface {
    ...
    void (*updateNfcOpenStatus)(const char* nfcStatus, int len);
    int (*checkNfcBootloaderStatus)(void);
};
